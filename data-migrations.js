(function () {
  ...
  function normalizeMeasurement(raw, fallbackDate) {
    ...
    const normalized = {
      ...
      measurementMethod: normalizeString(input.measurementMethod || input.method),
      measurementDevice: normalizeString(input.measurementDevice || input.device),
      measuredBy: normalizeString(input.measuredBy || input.measured_by || input.trainerName),
