(function () {
  ...
  function createOutputHandlers(deps) {
    ...
    // Refactor Adim 4A.2.2: action handler'lari → output/outputActions.js.
    // Refactor Adim 4A.2.3: handleSendProgramMail + mail helper'lari → output/outputMail.js.
    // Bu factory artik SADECE backup/CSV handler'lari return eder.
    return {
