(function () {
  ...
  const repetitionModelOptions = [
    ...
    { value: "strength", label: "Kuvvet Gelişimi (Strength)", description: "Kuvvet odakli dusuk tekrar" },
    { value: "hypertrophy", label: "Kas Gelişimi (Hypertrophy)", description: "Kas gelisimi odakli" },
